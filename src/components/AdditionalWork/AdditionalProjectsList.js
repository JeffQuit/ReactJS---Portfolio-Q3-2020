export const AdditionalProjectsList = [
	...
	},
	{
		id: 1,
		title: 'AADP2',
		src: require('./imgs/FitnessTracker.jpg'),
		url: '#AADP2',
		cName: 'AddWork-IMG',
		tNailName: 'Fitness Tracker',
		tNailClass: 'Tnail-CSSADD',
		modalTitle: 'Fitness Tracker',
		modalGif: require('./imgs/Gifs/FitnessTrackerp17.gif'),
	...
	},
	{
		id: 2,
		title: 'AADP3',
		src: require('./imgs/WeatherDash.jpg'),
		url: '#AADP3',
		cName: 'AddWork-IMG',
		tNailName: 'Weather Dashboard',
		tNailClass: 'Tnail-CSSADD',
		modalTitle: 'Weather Dashboard',
		modalGif: require('./imgs/Gifs/WeatherTracker.gif'),
	...
	},
	{
		id: 3,
		title: 'AADP4',
		src: require('./imgs/TeamGeneratorCLI.jpg'),
		url: '#AADP4',
		cName: 'AddWork-IMG',
		tNailName: 'Team Profile Generator',
		tNailClass: 'Tnail-CSSADD',
		modalTitle: 'Team Profile Generator',
		modalGif: require('./imgs/Gifs/TeamGeneratorGif.gif'),
		modalDesc:
	...
	},
	{
		id: 4,
		title: 'AADP5',
		src: require('./imgs/ReadMeGuide.jpg'),
		url: '#AADP5',
		cName: 'AddWork-IMG',
		tNailName: 'README.MD Generator',
		tNailClass: 'Tnail-CSSADD',
		modalTitle: 'README.MD Generator',
		modalGif: require('./imgs/Gifs/ReadMeGenerator.gif'),
	...
	},
	{
		id: 5,
		title: 'AADP6',
		src: require('./imgs/KrustyKrab.jpg'),
		url: '#AADP6',
		cName: 'AddWork-IMG',
		tNailName: 'Krusty Krab Simulator',
		tNailClass: 'Tnail-CSSADD',
		modalTitle: 'Krusty Krab Simulator',
		modalGif: require('./imgs/Gifs/KrustyKrabEatDaBurgerMySQLProject.gif'),
		modalDesc:
